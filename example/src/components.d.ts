...
import { IComplexProp } from "./components/my-component/my-component";
export { IComplexProp } from "./components/my-component/my-component";
...
declare namespace LocalJSX {
    interface MyComponent {
        ...
        /**
          * Event
         */
        "onCustomEvent"?: (event: MyComponentCustomEvent<string>) => void;
    }
